...
int main(void) {
    ...
    uart_puts("--- DBGMCU ---\n");
    {
        ...
        // Per-map device ID (init_svd_chip, default stm32f407): the F407
        // map reads back exactly 0x413; F429 reports its real DEV_ID 0x419.
        CHECK(dev == 0x413, "DBGMCU IDCODE DEV_ID");
    }
    DBGMCU_CR = 0x1F0077;
