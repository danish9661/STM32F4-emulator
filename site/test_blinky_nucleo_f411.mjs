...
// Usage: node site/test_blinky_nucleo_f411.mjs  (exit 0 = PASS)
import { readFileSync } from 'fs';
import * as bindings from './vendor/stm32_periph_wasm.js';
import { createEmulator } from './emulator.js';
import { boardFor } from './boards.js';

const board = boardFor('blinky_nucleo_f411');
const svdXml = readFileSync(new URL('./vendor/' + board.svd, import.meta.url), 'utf8');
const wasmBytes = new Uint8Array(readFileSync(new URL('./vendor/stm32_periph_wasm_bg.wasm', import.meta.url)));
const firmware = new Uint8Array(readFileSync(new URL('../firmware/blinky_nucleo_f411/blinky_nucleo_f411.bin', import.meta.url)));
...
const pass =
    all.includes('=== Blinky Nucleo-F411 ===') &&
